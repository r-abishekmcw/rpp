...
int main(int argc, char **argv)
{
    ...
    std::cerr << "\n\nIn test suite brightness....00\n\n";

    RpptDescPtr srcDesc, dstDesc;

    std::cerr << "\n\nIn test suite brightness....01\n\n";
    ...
    else if (ip_bitDepth == 1)
    {
        ...
        srcDesc->dataType = RpptDataType::F16;
        dstDesc->dataType = RpptDataType::F16;
    }
    ...
    else if (ip_bitDepth == 5)
    {
        ...
        srcDesc->dataType = RpptDataType::I8;
        dstDesc->dataType = RpptDataType::I8;
    }
    ...
    // RpptROI *srcBatchROI = (RpptROI *) calloc(noOfImages, sizeof(RpptROI));
    // RpptROI *dstBatchROI = (RpptROI *) calloc(noOfImages, sizeof(RpptROI));
    ...
    //     srcBatchROI[count].x1 = 0;
    //     srcBatchROI[count].y1 = 0;
    //     srcBatchROI[count].x2 = image.rows - 1;
    //     srcBatchROI[count].y2 = image.cols - 1;

    //     dstBatchROI[count].x1 = 0;
    //     dstBatchROI[count].y1 = 0;
    //     dstBatchROI[count].x2 = image.rows - 1;
    //     dstBatchROI[count].y2 = image.cols - 1;
    ...
    // srcDesc->n = noOfImages;
    // srcDesc->c = ip_channel;
    // srcDesc->h = maxSize.height;
    // srcDesc->w = maxSize.width;
    // dstDesc->n = noOfImages;
    // dstDesc->c = ip_channel;
    // dstDesc->h = maxDstSize.height;
    // dstDesc->w = maxDstSize.width;

    // srcDesc->strides.nStride = ip_channel * maxSize.width * maxSize.height;
    // srcDesc->strides.cStride = 1;
    // srcDesc->strides.hStride = ip_channel * maxSize.width;
    // srcDesc->strides.wStride = ip_channel;
    ...
    //         // rppt_brightness_host(input, srcDesc, output, dstDesc, srcBatchROI, alpha, beta, handle);
    //         std::cerr << "\n\nIn test suite brightness....\n\n";
    //     else if (ip_bitDepth == 1)
    //         missingFuncFlag = 1;
    //     else if (ip_bitDepth == 2)
    //         missingFuncFlag = 1;
